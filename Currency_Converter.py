...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        tk.Tk.__init__(self)
        self.title('Currency Converter - Muraduzaaman Asha')
        self.geometry('400x400')
        self.config(bg='#3A3B3C')
        self.CurrencyConverter = converter

        # Create title label
        self.title_label = Label(self, text='Currency Converter by Muraduzaaman Asha', bg='#3A3B3C', fg='white', font=('franklin gothic medium', 20), relief='sunken')
